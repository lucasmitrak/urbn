...
class Session
{
    ...
    /**
     * Gets Messages array for everyone
     * 
     * 
     * @return string
     */
    public static function getUserMessages()
    {
        ...
        //TODO: Set up sql conn to get messages
        if(isset($userId) && isset($session_id)) {

            $database = DatabaseFactory::getFactory()->getXnetNodeRootConnection();
            $sql = "SELECT `to`, `from`, `date_created`, `message` FROM node_messages WHERE `to` = :user_id";
    ...
    public static function getAdminMessages()
    {
        ...
        if(isset($session_id)) {
            ...
            $database = DatabaseFactory::getFactory()->getXnetNodeRootConnection();
            $sql = "SELECT `to`, `from`, `date_created`, `message` FROM node_messages WHERE `to` = 'admin'";
