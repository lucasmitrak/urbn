...
class SearcherController extends Controller
{
    ...
    {
        $commentcount=SearcherController::getCommentRowCount();
        $timelinecount=SearcherController::getTimelineRowCount();
        $midccount=SearcherController::getMidcRowCount();
	   $twittercount=SearcherController::getTwitterRowCount();
	   $macombjailcount=SearcherController::getMacombJailRowCount();
	   $oaklandjailcount=SearcherController::getOaklandJailRowCount();
	   $waynejailcount=SearcherController::getWayneJailRowCount();
	   $crisnetcount=SearcherController::getCrisnetRowCount();
        $this->View->render('searcher/index', array(
